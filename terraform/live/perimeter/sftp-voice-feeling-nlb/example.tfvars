...
#     --output table
#
# Or copy the values from the existing sftp-nlb leaf - same VPC and subnets.
###############################################################################
...
# Read from the production/sftp-voice-feeling leaf:
#   cd ../../production/sftp-voice-feeling && terraform output -raw private_ip
sftp_server_private_ip = "10.12.X.X"

sftp_port = 22

# Tighten to the partner's egress CIDRs. Default 0.0.0.0/0.
